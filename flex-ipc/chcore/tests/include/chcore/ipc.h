...
ipc_struct_t *__net_flex_ipc_struct_location();
#define fs_ipc_struct (__fs_ipc_struct_location())
// #define lwip_ipc_struct (__net_ipc_struct_location())
#define lwip_ipc_struct (__net_flex_ipc_struct_location())
...
#define FLEX_CLIENT_REGISTER_HANDLER flex_register_cb
...
ipc_msg_t *ipc_create_msg(ipc_struct_t *icb, u64 data_len,
			  u64 cap_slot_number);
ipc_msg_t *flex_ipc_create_msg(ipc_struct_t *icb, u64 data_len,
			  u64 cap_slot_number);
